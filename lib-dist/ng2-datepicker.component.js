...
export var DatePickerComponent = (function () {
    function DatePickerComponent(el, device) {
        var _this = this;
        this.el = el;
        this.device = device;
